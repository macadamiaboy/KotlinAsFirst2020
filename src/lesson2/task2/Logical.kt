...
fun daysInMonth(month: Int, year: Int): Int {
    return if ((month % 2 == 1) && (month < 8) || (month % 2 == 0) && (month > 7)) 31
    else if (month != 2) 30
    else {
        if ((year % 100 == 0 && year / 100 % 4 == 0) || (year % 100 != 0 && year % 4 == 0)) 29
        else 28
    }
}
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean {
    ...
    val middle = a + b + c - minbrick - maxbrick
    return (minbrick <= min(r, s)) && (middle <= max(r, s))
}

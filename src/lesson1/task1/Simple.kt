 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int) = PI * (deg + min / 60.0 + sec / 3600.0) / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int) = (1 + percent / 100.0).pow(3) * initial
 ...
 */
fun numberRevert(number: Int) = (number % 10) * 100 + (number % 100 - number % 10) + number / 100
